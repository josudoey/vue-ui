...
gulp.task('min:js', function () {
  return gulp.src(conf.static.path + '/**/*.css')
    .pipe(uglify())
...
gulp.task('min:html', function () {
  return gulp.src(conf.static.path + '/**/*.html')
    .pipe(htmlmin({
...
gulp.task('static', ['min:js', 'min:css', 'min:html'])

gulp.task('build', ['static', 'webpack'])

gulp.task('watch', function () {
  gulp.watch(conf.static.path + '/**/*', ['static'])
  gulp.watch(conf.webpack.resolve.alias["~"], ['webpack'])
})
